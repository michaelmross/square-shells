...
The program scans EVERY n in a requested range.  It reports:
  ...
  * sampled rows to a CSV for later inspection.
...
def main() -> None:
    ...
    # We write failures even if they do not fall on the sampling stride.
    last_written_n = None
    ...
    print(f"Sampled/failure detail written to: {args.out}")
